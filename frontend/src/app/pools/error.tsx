...
export default function PoolsError({
  ...
  return (
    <div className="text-center py-12">
      <h2 className="text-lg font-medium mb-2">Failed to Load Pools</h2>
      <p className="text-sm text-zinc-500 mb-4">
        Could not read pool data from the Fuji network. Make sure your wallet is connected to Avalanche Fuji (chain ID 43113).
      </p>
